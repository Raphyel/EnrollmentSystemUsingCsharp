...
{
    public partial class adminbsba : UserControl
    {
        public static adminbsba _instance;
        public static adminbsba instance
        {
            get
            {
                if (_instance == null)
                    _instance = new adminbsba();
                return _instance;
            }
        ...
        private void adminbsba_Load(object sender, EventArgs e)
        {
            searchData("");
            Fillcombo();
        }
        ...
        {
            string deleteQuery = "DELETE FROM tblbsba WHERE student_id =" + int.Parse(student_id.Text);
