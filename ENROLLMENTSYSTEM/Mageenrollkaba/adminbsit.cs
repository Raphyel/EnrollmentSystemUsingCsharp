...
{
    public partial class adminbsit : UserControl
    {

        public static adminbsit _instance;
        public static adminbsit instance
        {
            get
            {
                if (_instance == null)
                    _instance = new adminbsit();
                return _instance;
            }
        ...
        private void adminbsit_Load(object sender, EventArgs e)
        {
            searchData("");
            Fillcombo();
        ...
        private void delete_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            string deleteQuery = "DELETE FROM tblbsit WHERE student_id =" + int.Parse(student_id.Text);
