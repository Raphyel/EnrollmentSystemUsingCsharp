...
namespace Mageenrollkaba.loginDBDataSet1TableAdapters {
    ...
    public partial class TblAdminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TblAdmin] SET [UserName] = @UserName, [Password] = @Password WHERE (([ID]" +
                " = @Original_ID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Mageenrollkaba.Properties.Settings.Default.loginDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ID], [UserName], [Password] FROM [TblAdmin]";
        ...
        public virtual int Fill(loginDBDataSet1.TblAdminDataTable dataTable) {
        ...
        public virtual loginDBDataSet1.TblAdminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            loginDBDataSet1.TblAdminDataTable dataTable = new loginDBDataSet1.TblAdminDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loginDBDataSet1.TblAdminDataTable dataTable) {
        ...
        public virtual int UpdateAll(loginDBDataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._tblAdminTableAdapter != null)) {
                    ...
                    this._tblAdminTableAdapter.Connection = ((global::System.Data.SqlServerCe.SqlCeConnection)(workConnection));
                    this._tblAdminTableAdapter.Transaction = ((global::System.Data.SqlServerCe.SqlCeTransaction)(workTransaction));
                ...
                if ((this._tblAdminTableAdapter != null)) {
                    this._tblAdminTableAdapter.Connection = ((global::System.Data.SqlServerCe.SqlCeConnection)(revertConnections[this._tblAdminTableAdapter]));
